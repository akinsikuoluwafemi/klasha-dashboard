			...
			<Layout className="site-layout">
				<div className="site-layout-background" style={{ padding: '0' }}>
					<HeaderContent>
						...
						<UserNotificationWrapper>
							<div style={{ height: '4rem', width: '4rem', background: '#F5F5F5', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
								<span style={{marginTop: '5px'}}>
									<NotificationIcon />
								</span>
								<span style={{ height: '1rem', width: '1rem', background: 'red', borderRadius: '50%', position: 'absolute', top: '0', left: '25px'}}></span>
							</div>
						</UserNotificationWrapper>
					</HeaderContent>
				</div>
