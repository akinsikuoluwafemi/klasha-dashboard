...
import {DashboardIcon, CustomerIcon, Wallet, AnalyticsIcon } from '../assets/icon';
		...
		<Layout style={{ height: '100vh' }}>
			<Sider trigger={null} collapsible collapsed={collapsed}>
				...
				<Menu theme="dark" defaultSelectedKeys={['2']} mode="inline" defaultOpenKeys={['sub1', 'sub2']}>
					<SubMenu key="sub1" title={<MenuText style={{ fontWeight: '600', color: '#000' }}>Main pages</MenuText>}>
					...
					<SubMenu key="sub2" title="General">
